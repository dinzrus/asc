...
<div class="collector-index">
    ...
    <p>
        <?= Html::a('Create Collector', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Branch', 'id' => 'grid-collector-search-branch_id']
            ],
        [
                'attribute' => 'unit_id',
                'label' => 'Unit',
                ...
                'filterInputOptions' => ['placeholder' => 'Unit', 'id' => 'grid-collector-search-unit_id']
            ],
        [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-collector']],
        'panel' => [
