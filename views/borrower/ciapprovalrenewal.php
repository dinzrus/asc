...
$this->title = 'C.I. Approval Renewal';
                                ...
                                <table class="table table-condensed table-hover">
                                    <tr>
                                        ...
                                        <td class="align-right">
                                            <?=
                                            $form->field($loan, 'loan_type')->widget(\kartik\widgets\Select2::classname(), [
                                                'data' => \yii\helpers\ArrayHelper::map(\app\models\base\LoanType::find()->all(), 'loan_id', 'loan_description'),
                                                'options' => [
...
<?php $this->registerJsFile("@web/js/ciapprovalrenewal.js", ['depends' => [\yii\web\JqueryAsset::className()]]); ?>