...
<div class="emposition-index">
    ...
    <p>
        <?= Html::a('Create Emposition', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    return $model->employee->id;
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Employee::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
